...
## New beta version 3.0.0b is available, which contains the following major changes/additions:
...
This will currently install the latest standard version `2.0.19`. The beta version `3.0.0b` can be downloaded separately [here](TBD).
