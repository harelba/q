...
|[Ubuntu Package](https://packages.ubuntu.com/oracular/python3-q-text-as-data)|Run `sudo apt-get install python-q-text-as-data`|This is not officially maintained|
